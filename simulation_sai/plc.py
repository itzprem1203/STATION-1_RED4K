    ...
    if client.connect():
        ...
        try:
            while True:
                ...
                # ✅ NOW Read D1003 register value here every 0.1s
                try:
                    reg_result = client.read_holding_registers(1100, 2, slave=SLAVE_ID)
                    if reg_result and not reg_result.isError():
                        ...
                        print("❌ Failed to read register D1003")
                except Exception as e:
                    print("⛔ Error reading register 1003:", e)
